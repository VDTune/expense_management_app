import 'package:expense_management_app/features/main/search.dart';
...
class CalendarTable extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // int startDayIndex = DateTime(2025, 3).weekday-1;
    // int numberOfDays = DateTime(2025, 3+1, 0).day;
    return Column(
      children: [
        Row(
        ...
        SizedBox(
          height: ((numberOfDays+startDayIndex-1)~/5)*39.2,
